...
def generate_launch_description():
    ...
    # OptiTrack pose covariance publisher node (regular node, not lifecycle)
    posecov_publisher_node = Node(
        name='optitrack_posecov_publisher',
        namespace='',
        package='terrarium_optitrack',
        executable='optitrack_posecov_publisher_node',
        output='screen',
    )
    ...
    ld.add_action(posecov_publisher_node)
